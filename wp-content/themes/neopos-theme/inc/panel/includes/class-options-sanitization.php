...
/**
 * Validates that the $input is a inter value
 *
 * @param string $input
 * @returns string $output
 */
 ...
 * @returns string $output
 */
function of_sanitize_groupstart( $input ) {
	if ( is_array( $input ) ) {
		foreach( $input as $key => $value ) {
		$output[$key] = apply_filters( 'of_sanitize_num', $input[$key] );
		}
	}
	return $output;
}
add_filter( 'of_sanitize_groupstart', 'of_sanitize_groupstart' );
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'accesspress-root' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'accesspress-root' ),
		'repeat-y'  => __( 'Repeat Vertically', 'accesspress-root' ),
		'repeat'    => __( 'Repeat All', 'accesspress-root' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'accesspress-root' ),
		'top center'    => __( 'Top Center', 'accesspress-root' ),
		'top right'     => __( 'Top Right', 'accesspress-root' ),
		'center left'   => __( 'Middle Left', 'accesspress-root' ),
		'center center' => __( 'Middle Center', 'accesspress-root' ),
		'center right'  => __( 'Middle Right', 'accesspress-root' ),
		'bottom left'   => __( 'Bottom Left', 'accesspress-root' ),
		'bottom center' => __( 'Bottom Center', 'accesspress-root' ),
		'bottom right'  => __( 'Bottom Right', 'accesspress-root')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'accesspress-root' ),
		'fixed'  => __( 'Fixed in Place', 'accesspress-root')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'accesspress-root' ),
		'italic'      => __( 'Italic', 'accesspress-root' ),
		'bold'        => __( 'Bold', 'accesspress-root' ),
		'bold italic' => __( 'Bold Italic', 'accesspress-root' )
		);
